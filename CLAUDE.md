...
| 11 | Monitoring & Production Deployment (Sentry, PostHog, UptimeRobot health check) | 🟡 **Partial:** `GET /api/health` route done (Phase 11.3 — DB-warm probe). Sentry/PostHog (11.1/2) account-gated; UptimeRobot pointing + prod-config pending. |
