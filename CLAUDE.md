...
| 11 | Monitoring & Production Deployment (Sentry, PostHog, UptimeRobot health check) | 🟡 **Mostly done:** `/api/health` (11.3); **Sentry (11.1)**; **PostHog (11.2)** incl. the 3 named events (started/completed/risk_shown). All env vars set in Vercel. **Left:** point UptimeRobot at `/api/health`. |
