...
| 10 | Testing (Vitest; triage regression set from 5.14) | 🟡 **Started:** Vitest + 50 unit tests (safety override, fallback, schemas, model-down regression) pass. Integration/perf/manual deferred to post-Next-15. |
