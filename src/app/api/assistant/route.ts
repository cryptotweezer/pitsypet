          ...
          propose_add_medication: tool({
            ...
            parameters: z.object({
              ...
              prescribed_doctor: z
                .string()
                .optional()
                .describe("The prescribing doctor's name, e.g. 'Dr Smith'"),
