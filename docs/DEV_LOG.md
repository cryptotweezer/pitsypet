...
### NEXT SESSION MUST START WITH
*(End-of-session update: limits verified by the user on a Basic account — the 10-message assistant toast works; everything COMMITTED + PUSHED. `STRIPE_SECRET_KEY` added to Vercel by the user.)*
